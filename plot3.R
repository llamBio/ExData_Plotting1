##=============================================================================
# plot3.R Energy sub meeting Line Graph Day of Week
##=============================================================================
library(dplyr)
...
legend('topright','',c("Sub_meeting_1","Sub_meeting_2","Sub_meeting_3"), lty = c(1,1,1),col=c('black','red','blue'),ncol=1,bty ="1")
dev.off()